feature 'Seller view sales' do
  scenario 'successfully' do
    ...
    flip_flop = Product.create!(name: 'Chinelo', category: 'Vestuário', price: '20,00',
                                ...
                                status: :available)
    sale = Sale.create!(final_price: '380,00', product: tire, profile: second_profile)
    ...
    expect(page).to have_content('Pneu R$ 380,00 - Vendido')
    expect(page).to have_content('Chinelo R$ 20,00 - Disponível')
  end
  ...
  scenario 'and view product details when has a sale' do
    enterprise = Enterprise.create!(name: 'Alimentos Estrela', cnpj: '41.736.335/0001-50',
                                    email: 'comercial@estrela.com', country: 'Brasil',
                                    state: 'São Paulo', address: 'Rua Dois, 22')
    user = User.create!(email: 'caio.valerio@estrela.com', password: '123456')
  ...
  scenario 'and view announced product details' do
    enterprise = Enterprise.create!(name: 'Alimentos Estrela', cnpj: '41.736.335/0001-50',
                                    email: 'comercial@estrela.com', country: 'Brasil',
                                    state: 'São Paulo', address: 'Rua Dois, 22')
    user = User.create!(email: 'caio.valerio@estrela.com', password: '123456')
    ...
    click_on 'Panela R$ 60,00 - Vendido'
  ...
  scenario 'and view announced available product details' do
    enterprise = Enterprise.create!(name: 'Alimentos Estrela', cnpj: '41.736.335/0001-50',
                                    email: 'comercial@estrela.com', country: 'Brasil',
                                    state: 'São Paulo', address: 'Rua Dois, 22')
    user = User.create!(email: 'caio.valerio@estrela.com', password: '123456')
    ...
    visit root_path
    click_on 'Compras/Vendas'
    click_on 'Panela R$ 50,00 - Disponível'
